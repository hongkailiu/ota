...
Total: 13 issues | Pixaa: 5 (not closed: 5) | New: 1 | ASSIGNED: 2 | POST: 3 | ON_QA: 2 | Verified: 3 | Closed: 2
...
| 5 | [OCPBUGS-64852](https://redhat.atlassian.net/browse/OCPBUGS-64852) | Cluster Operator cloud-controller-manager did not report Progressing=True during a cluster update | ON_QA |  | 5.0.0 |  | Cloud Compute / Cloud Controller Manager | ✓ | Theo Barber-Bany | OCPCLOUD-3420 | Under evaluation |
| 6 | [OCPBUGS-66101](https://redhat.atlassian.net/browse/OCPBUGS-66101) | Cluster Operator baremetal did not report Progressing=True during a cluster update | POST |  | 5.0.0 | Approved | Bare Metal Hardware Provisioning |  | Iury Gregory Melo Ferreira |  |  |
...
| 8 | [OCPBUGS-67134](https://redhat.atlassian.net/browse/OCPBUGS-67134) | console ClusterOperator should not blip Available=False with the reason=Deployment_InsufficientReplicas | POST |  | 5.0.0 |  | Management Console | ✓ | Steve Goodwin | CONSOLE-5185 |  |
...
| 10 | [OCPBUGS-85677](https://redhat.atlassian.net/browse/OCPBUGS-85677) | cluster operator network reported Progressing=True for a node reboot | Closed | Duplicate | 5.0.0 | Rejected | Networking / cluster-network-operator |  | Jamo Luhrsen |  | To be removed in 5.1 |
...
* Build: v20260706-62449e6

* `git_commit_origin`: v4.1.0-11633-g896f874311
